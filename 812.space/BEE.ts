...
import MaprpgUnit from "./04.maprpg.unit/maprpg.unit";
...
import Maprpg from "./04.maprpg.unit/fce/maprpg.interface";
import { MaprpgModel } from "./04.maprpg.unit/maprpg.model";
...
export const list: Array<any> = [SpaceUnit,FocusUnit,GeojsonUnit,HexmapUnit,MaprpgUnit,PivotUnit,CollectUnit,MenuUnit,BusUnit];
...
import * as reduceFromMaprpg from "./04.maprpg.unit/maprpg.reduce";
